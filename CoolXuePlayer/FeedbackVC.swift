...
class FeedbackVC: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let nib = UINib(nibName: "FeedbackTabVCell", bundle: nil)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("FeedbackTabVCellID", forIndexPath: indexPath) as? FeedbackTabVCell
        let feedbackModel = self.feedbackList[indexPath.row]
