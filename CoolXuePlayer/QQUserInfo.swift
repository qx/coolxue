...
class QQUserInfo: NSObject {
    ...
    func setQQUserInfo(dictQQUser:NSDictionary){
        let nickname:String! = dictQQUser["nickname"] as? String
        let is_lost:Int! = dictQQUser["is_lost"] as? Int
        let gender:String! = dictQQUser["gender"] as? String
        let province:String! = dictQQUser["province"] as? String
        let city:String! = dictQQUser["city"] as? String
        let vip:Int! = dictQQUser["vip"] as? Int
        let is_yellow_vip:Int! = dictQQUser["is_yellow_vip"] as? Int
        let yellow_vip_level:Int! = dictQQUser["yellow_vip_level"] as? Int
        let is_yellow_year_vip:Int! = dictQQUser["is_yellow_year_vip"] as? Int
        let figureurl:String! = dictQQUser["figureurl"] as? String
        let figureurl_qq_1:String! = dictQQUser["figureurl_qq_1"] as? String
        let figureurl_1:String! = dictQQUser["figureurl_qq_1"] as? String
        let figureurl_2:String! = dictQQUser["figureurl_qq_1"] as? String
        let level:Int! = dictQQUser["figureurl_qq_1"] as? Int
