...
//        }
        ...
        var bodyParam:[String:AnyObject] = ["username":userid!,"password" :upwd!]
...
//                do {
//            var bdict:NSDictionary = try NSJSONSerialization.JSONObjectWithData(response.responseObject as! NSData, options: NSJSONReadingOptions.AllowFragments) as!NSDictionary
//                print(bdict)
//                var code:Int = bdict["code"] as! Int
//                if HttpManagement.HttpResponseCodeCheck(code, viewController: self){
...
//        }
    ...
    @IBAction func bnQQLoginClicked(sender: UIButton) {
        ...
        print("accessToken=====>\(self.qqLogin.tencentOAuth.accessToken)")
        print("expirationDate=====>\(self.qqLogin.tencentOAuth.expirationDate)")
        print("authorizeState=====>\(TencentOAuth.authorizeState)")
        print("authMode=====>\(self.qqLogin.tencentOAuth.authMode)")
        //qq授权
    ...
    func qqAuthorizeCallBack(cancelled:Bool,loginSucceed:Bool){
        ...
        if loginSucceed {
            if self.qqLogin.tencentOAuth.accessToken != nil{
                ...
                print("accessToken=\(self.qqLogin.tencentOAuth.accessToken)")//D49FC381ECFDEDA8B72DC8776BC44974
                print("openId=\(self.qqLogin.tencentOAuth.openId)")//FD70E2CF311CCE980467453A4A26FAF4
                print("expirationDate=\(self.qqLogin.tencentOAuth.expirationDate)")//2015-08-13 07:03:49 +0000
                //自己服务登录
    ...
    func qqGetUserInfoResponseCallBack(response: APIResponse!){
        ...
        print("self.qqUserInfo.nickname=\(self.qqUserInfo.nickname)")
    }
