...
class LoginTool: NSObject {
    ...
    static func autoLogin(){
        let userAccount:NSUserDefaults = NSUserDefaults.standardUserDefaults()
        var is_login:Bool? = userAccount.objectForKey("is_login") as? Bool
        let uid:String? = userAccount.objectForKey("uid") as? String
        let upwd:String? = userAccount.objectForKey("upwd") as? String
        if uid != nil && upwd != nil {
