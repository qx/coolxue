...
protocol LoadMoreFooterViewDelegate{
    func footerRefreshTableData(_: Vedio)
}
...
//        var dict:NSDictionary = NSDictionary(objects: keys as [AnyObject], forKeys: values as [AnyObject])
        ...
        let popTime:dispatch_time_t = dispatch_time(DISPATCH_TIME_NOW, Int64(NSEC_PER_MSEC.hashValue * 1000))
        ...
        dispatch_after(popTime, dispatch_get_main_queue()) { () -> Void in
            ...
            let newVedio:Vedio = Vedio(dictVedio: dict)
